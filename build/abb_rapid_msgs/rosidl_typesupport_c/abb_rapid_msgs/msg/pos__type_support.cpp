...
#include "abb_rapid_msgs/msg/detail/pos__type_support.h"
...
static const _Pos_type_support_symbol_names_t _Pos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_rapid_msgs, msg, Pos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_rapid_msgs, msg, Pos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_rapid_msgs, msg, Pos)() {
  return &::abb_rapid_msgs::msg::rosidl_typesupport_c::Pos_message_type_support_handle;
}
