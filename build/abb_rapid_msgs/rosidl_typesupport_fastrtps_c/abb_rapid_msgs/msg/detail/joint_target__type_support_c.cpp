...
#include "abb_rapid_msgs/msg/detail/joint_target__rosidl_typesupport_fastrtps_c.h"
...
#include "abb_rapid_msgs/msg/detail/rob_joint__functions.h"  // robax
...
using _JointTarget__ros_msg_type = abb_rapid_msgs__msg__JointTarget;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointTarget__ros_msg_type * ros_message = static_cast<const _JointTarget__ros_msg_type *>(untyped_ros_message);
  // Field name: robax
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, abb_rapid_msgs, msg, RobJoint
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->robax, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _JointTarget__ros_msg_type * ros_message = static_cast<_JointTarget__ros_msg_type *>(untyped_ros_message);
  // Field name: robax
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_abb_rapid_msgs__msg__JointTarget(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointTarget__ros_msg_type * ros_message = static_cast<const _JointTarget__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_abb_rapid_msgs__msg__RobJoint(
...
static uint32_t _JointTarget__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abb_rapid_msgs__msg__JointTarget(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abb_rapid_msgs
size_t max_serialized_size_abb_rapid_msgs__msg__JointTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: robax
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_abb_rapid_msgs__msg__RobJoint(
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs__msg__JointTarget;
    is_plain =
      (
...
static size_t _JointTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abb_rapid_msgs__msg__JointTarget(
...
static message_type_support_callbacks_t __callbacks_JointTarget = {
  "abb_rapid_msgs::msg",
  "JointTarget",
...
static rosidl_message_type_support_t _JointTarget__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointTarget,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_rapid_msgs, msg, JointTarget)() {
  return &_JointTarget__type_support;
}
