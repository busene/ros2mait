...
#include "abb_rapid_msgs/msg/detail/orient__rosidl_typesupport_fastrtps_c.h"
...
using _Orient__ros_msg_type = abb_rapid_msgs__msg__Orient;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Orient__ros_msg_type * ros_message = static_cast<const _Orient__ros_msg_type *>(untyped_ros_message);
  // Field name: q1
  {
    cdr << ros_message->q1;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Orient__ros_msg_type * ros_message = static_cast<_Orient__ros_msg_type *>(untyped_ros_message);
  // Field name: q1
  {
    cdr >> ros_message->q1;
  }
...
static uint32_t _Orient__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abb_rapid_msgs__msg__Orient(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs__msg__Orient;
    is_plain =
      (
...
static size_t _Orient__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abb_rapid_msgs__msg__Orient(
...
static message_type_support_callbacks_t __callbacks_Orient = {
  "abb_rapid_msgs::msg",
  "Orient",
...
static rosidl_message_type_support_t _Orient__type_support = {
