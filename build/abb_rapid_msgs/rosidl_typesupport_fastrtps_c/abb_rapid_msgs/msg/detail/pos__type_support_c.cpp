...
#include "abb_rapid_msgs/msg/detail/pos__rosidl_typesupport_fastrtps_c.h"
...
using _Pos__ros_msg_type = abb_rapid_msgs__msg__Pos;
...
static uint32_t _Pos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abb_rapid_msgs__msg__Pos(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs__msg__Pos;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Pos__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abb_rapid_msgs__msg__Pos(
