...
#include "abb_rapid_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = abb_rapid_msgs__msg__Pose;
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abb_rapid_msgs__msg__Pose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs__msg__Pose;
    is_plain =
      (
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abb_rapid_msgs__msg__Pose(
