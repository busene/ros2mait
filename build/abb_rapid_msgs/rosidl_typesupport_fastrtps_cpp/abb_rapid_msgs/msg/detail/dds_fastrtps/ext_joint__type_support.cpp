...
#include "abb_rapid_msgs/msg/detail/ext_joint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abb_rapid_msgs::msg::ExtJoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abb_rapid_msgs::msg::ExtJoint & ros_message)
{
  // Member: eax_a
  cdr >> ros_message.eax_a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs::msg::ExtJoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abb_rapid_msgs::msg::ExtJoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abb_rapid_msgs::msg::ExtJoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ExtJoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const abb_rapid_msgs::msg::ExtJoint *>(
...
static size_t _ExtJoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ExtJoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ExtJoint__callbacks = {
  "abb_rapid_msgs::msg",
  "ExtJoint",
...
static rosidl_message_type_support_t _ExtJoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExtJoint__callbacks,
...
{
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_ExtJoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abb_rapid_msgs, msg, ExtJoint)() {
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_ExtJoint__handle;
}
