...
#include "abb_rapid_msgs/msg/detail/pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abb_rapid_msgs::msg::Pos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abb_rapid_msgs::msg::Pos & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs::msg::Pos;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const abb_rapid_msgs::msg::Pos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abb_rapid_msgs::msg::Pos *>(
    untyped_ros_message);
...
static size_t _Pos__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Pos(full_bounded, is_plain, 0);
...
{
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_Pos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abb_rapid_msgs, msg, Pos)() {
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_Pos__handle;
}
