...
#include "abb_rapid_msgs/msg/detail/rob_target__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const abb_rapid_msgs::msg::ConfData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const abb_rapid_msgs::msg::RobTarget & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abb_rapid_msgs::msg::RobTarget & ros_message)
{
  // Member: trans
  ...
  size_t current_alignment)
{
  ...
  // Member: robconf
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        abb_rapid_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ConfData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_msgs::msg::RobTarget;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abb_rapid_msgs::msg::RobTarget *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abb_rapid_msgs::msg::RobTarget *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobTarget__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const abb_rapid_msgs::msg::RobTarget *>(
...
static size_t _RobTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobTarget(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobTarget__callbacks = {
  "abb_rapid_msgs::msg",
  "RobTarget",
...
static rosidl_message_type_support_t _RobTarget__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobTarget__callbacks,
...
{
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_RobTarget__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abb_rapid_msgs, msg, RobTarget)() {
  return &abb_rapid_msgs::msg::typesupport_fastrtps_cpp::_RobTarget__handle;
}
