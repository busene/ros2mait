...
#include "abb_rapid_sm_addin_msgs/msg/detail/egm_stop_settings__rosidl_typesupport_fastrtps_c.h"
...
using _EGMStopSettings__ros_msg_type = abb_rapid_sm_addin_msgs__msg__EGMStopSettings;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EGMStopSettings__ros_msg_type * ros_message = static_cast<const _EGMStopSettings__ros_msg_type *>(untyped_ros_message);
  // Field name: ramp_out_time
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EGMStopSettings__ros_msg_type * ros_message = static_cast<_EGMStopSettings__ros_msg_type *>(untyped_ros_message);
  // Field name: ramp_out_time
  {
    cdr >> ros_message->ramp_out_time;
  }
...
static uint32_t _EGMStopSettings__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abb_rapid_sm_addin_msgs__msg__EGMStopSettings(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_sm_addin_msgs__msg__EGMStopSettings;
    is_plain =
      (
...
static size_t _EGMStopSettings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abb_rapid_sm_addin_msgs__msg__EGMStopSettings(
...
static message_type_support_callbacks_t __callbacks_EGMStopSettings = {
...
static rosidl_message_type_support_t _EGMStopSettings__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EGMStopSettings,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_rapid_sm_addin_msgs, msg, EGMStopSettings)() {
  return &_EGMStopSettings__type_support;
}
