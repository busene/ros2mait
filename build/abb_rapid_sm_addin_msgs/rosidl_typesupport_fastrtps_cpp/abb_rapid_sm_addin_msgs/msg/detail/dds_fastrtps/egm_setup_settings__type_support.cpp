...
#include "abb_rapid_sm_addin_msgs/msg/detail/egm_setup_settings__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_sm_addin_msgs::msg::EGMSetupSettings;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abb_rapid_sm_addin_msgs::msg::EGMSetupSettings *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abb_rapid_sm_addin_msgs::msg::EGMSetupSettings *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EGMSetupSettings__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const abb_rapid_sm_addin_msgs::msg::EGMSetupSettings *>(
...
static size_t _EGMSetupSettings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EGMSetupSettings(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EGMSetupSettings__callbacks = {
...
static rosidl_message_type_support_t _EGMSetupSettings__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EGMSetupSettings__callbacks,
...
{
  return &abb_rapid_sm_addin_msgs::msg::typesupport_fastrtps_cpp::_EGMSetupSettings__handle;
}
