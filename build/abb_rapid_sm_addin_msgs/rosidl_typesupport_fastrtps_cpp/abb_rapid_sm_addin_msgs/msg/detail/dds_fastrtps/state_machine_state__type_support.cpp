...
#include "abb_rapid_sm_addin_msgs/msg/detail/state_machine_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abb_rapid_sm_addin_msgs::msg::StateMachineState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: rapid_task
  cdr << ros_message.rapid_task;
  // Member: sm_state
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abb_rapid_sm_addin_msgs::msg::StateMachineState & ros_message)
{
  // Member: rapid_task
  cdr >> ros_message.rapid_task;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abb_rapid_sm_addin_msgs::msg::StateMachineState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abb_rapid_sm_addin_msgs::msg::StateMachineState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abb_rapid_sm_addin_msgs::msg::StateMachineState *>(
    untyped_ros_message);
...
static size_t _StateMachineState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StateMachineState(full_bounded, is_plain, 0);
...
{
  return &abb_rapid_sm_addin_msgs::msg::typesupport_fastrtps_cpp::_StateMachineState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abb_rapid_sm_addin_msgs, msg, StateMachineState)() {
  return &abb_rapid_sm_addin_msgs::msg::typesupport_fastrtps_cpp::_StateMachineState__handle;
}
