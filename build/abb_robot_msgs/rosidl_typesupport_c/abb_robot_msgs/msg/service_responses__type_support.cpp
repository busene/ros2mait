...
#include "abb_robot_msgs/msg/detail/service_responses__type_support.h"
...
static const _ServiceResponses_type_support_symbol_names_t _ServiceResponses_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, msg, ServiceResponses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, msg, ServiceResponses)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, msg, ServiceResponses)() {
  return &::abb_robot_msgs::msg::rosidl_typesupport_c::ServiceResponses_message_type_support_handle;
}
