...
#include "abb_robot_msgs/srv/detail/get_rapid_bool__type_support.h"
...
static const _GetRAPIDBool_Request_type_support_symbol_names_t _GetRAPIDBool_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDBool_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDBool_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDBool_Request)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDBool_Request_message_type_support_handle;
}
...
static const _GetRAPIDBool_Response_type_support_symbol_names_t _GetRAPIDBool_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDBool_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDBool_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDBool_Response)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDBool_Response_message_type_support_handle;
}
...
static const _GetRAPIDBool_type_support_symbol_names_t _GetRAPIDBool_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDBool)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDBool)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDBool)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDBool_service_type_support_handle;
}
