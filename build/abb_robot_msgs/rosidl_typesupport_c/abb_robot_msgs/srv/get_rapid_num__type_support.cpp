...
#include "abb_robot_msgs/srv/detail/get_rapid_num__type_support.h"
...
static const _GetRAPIDNum_Request_type_support_symbol_names_t _GetRAPIDNum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDNum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDNum_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDNum_Request)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDNum_Request_message_type_support_handle;
}
...
static const _GetRAPIDNum_Response_type_support_symbol_names_t _GetRAPIDNum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDNum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDNum_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDNum_Response)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDNum_Response_message_type_support_handle;
}
...
static const _GetRAPIDNum_type_support_symbol_names_t _GetRAPIDNum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abb_robot_msgs, srv, GetRAPIDNum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abb_robot_msgs, srv, GetRAPIDNum)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, abb_robot_msgs, srv, GetRAPIDNum)() {
  return &::abb_robot_msgs::srv::rosidl_typesupport_c::GetRAPIDNum_service_type_support_handle;
}
