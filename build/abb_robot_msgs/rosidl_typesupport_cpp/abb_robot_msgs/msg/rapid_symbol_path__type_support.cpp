...
static const _RAPIDSymbolPath_type_support_symbol_names_t _RAPIDSymbolPath_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abb_robot_msgs, msg, RAPIDSymbolPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, abb_robot_msgs, msg, RAPIDSymbolPath)),
  }
};
...
{
  return &::abb_robot_msgs::msg::rosidl_typesupport_cpp::RAPIDSymbolPath_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, abb_robot_msgs, msg, RAPIDSymbolPath)() {
  return get_message_type_support_handle<abb_robot_msgs::msg::RAPIDSymbolPath>();
}
