...
#include "ros2srrc_data/msg/detail/xyz__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2srrc_data::msg::Xyz & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2srrc_data::msg::Xyz & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2srrc_data::msg::Xyz;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2srrc_data::msg::Xyz *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2srrc_data::msg::Xyz *>(
    untyped_ros_message);
...
static size_t _Xyz__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Xyz(full_bounded, is_plain, 0);
...
{
  return &ros2srrc_data::msg::typesupport_fastrtps_cpp::_Xyz__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2srrc_data, msg, Xyz)() {
  return &ros2srrc_data::msg::typesupport_fastrtps_cpp::_Xyz__handle;
}
