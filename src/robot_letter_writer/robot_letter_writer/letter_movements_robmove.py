        ...
        for path, attr in zip(paths, attributes):       # this piece of codes takes the XY coordinates out of a SVG file
            ...
            for segment in path:
                if isinstance(segment, Line):
                    ...
                    num_points = 5  # Adjust for finer or coarser approximation
    ...
    def movement_from_svg(self, char):
        ...
        try:
            ...
            for point in xy_coordinates:
                # Divide coordinates by 500, idk what the right value is to make it work. But SVG coordinates are way off from ROS coordinates
                x, y = point[0] / 500, point[1] / 500
                ...
                InputPose.x = x
                InputPose.y = y
                InputPose.z = 0.05  # Adjust z-coordinate as needed
                InputPose.qx = 0.0
                InputPose.qy = 1.0
                InputPose.qz = 0.0
                InputPose.qw = 0.0
...
def get_letter_movements(char):
    ...
    movement_map = {
        'a': movements.movement_from_svg('a'),
        'b': movements.movement_from_svg('b'),
        'c': movements.movement_from_svg('c'),
